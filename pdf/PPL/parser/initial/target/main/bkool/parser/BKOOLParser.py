...
class BKOOLParser ( Parser ):
    ...
    class Typ_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitTyp_" ):
                return visitor.visitTyp_(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Retur_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitRetur_" ):
                return visitor.visitRetur_(self)
            else:
                return visitor.visitChildren(self)
    ...
    class Call_Context(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if hasattr( visitor, "visitCall_" ):
                return visitor.visitCall_(self)
            else:
                return visitor.visitChildren(self)
